              ...
              {currentPerson ? (
                <div className="relative overflow-visible">
                  ...
                  {people[currentPersonIndex + 1] && (
                    <div className="absolute top-0 right-[-120px] w-full h-full bg-white rounded-2xl shadow-xl z-0 transform rotate-3 scale-90 opacity-70 border-2 border-blue-300">
                      <div className="h-48 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-t-2xl flex items-center justify-center">
                  ...
                  {people[currentPersonIndex + 1] && (
                    <div className="absolute top-4 left-4 right-4 bottom-4 bg-white rounded-2xl shadow-2xl z-1 transform rotate-2 scale-95 opacity-80 border-2 border-purple-200">
                      <div className="h-48 bg-gradient-to-br from-purple-300 to-pink-300 rounded-t-2xl flex items-center justify-center">
                      ...
                      <div className="p-4">
                        <div className="h-5 bg-purple-200 rounded mb-2"></div>
