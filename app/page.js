                ...
                <div className="relative overflow-visible">
                  ...
                  {people[currentPersonIndex + 1] && (
                    <div className="absolute top-0 -right-6 w-full h-full bg-white rounded-2xl shadow-lg z-0 transform rotate-2 scale-95 opacity-30 border border-gray-200">
                      <div className="h-48 bg-gradient-to-br from-indigo-200 to-purple-200 rounded-t-2xl"></div>
                    </div>
                  )}
                  ...
                  {people[currentPersonIndex + 1] && (
                    <div className="absolute -top-2 -left-2 -right-2 -bottom-2 bg-white rounded-2xl shadow-lg z-2 transform rotate-0.5 scale-98 opacity-70 border border-gray-300">
                      <div className="h-48 bg-gradient-to-br from-indigo-300 to-purple-300 rounded-t-2xl flex items-center justify-center">
                        <div className="text-white text-xs font-medium bg-black bg-opacity-30 px-2 py-1 rounded">Next Person</div>
                      </div>
                      <div className="p-4">
