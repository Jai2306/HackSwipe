                  ...
                  {showUndo.hackathons && lastRejectedHackathon && (
                    ...
                    >
                      <div className="bg-white rounded-lg shadow-lg border-2 border-red-200 p-2 w-20 h-24 cursor-pointer hover:shadow-xl transition-all duration-200"
                        ...
                        <div className="h-12 bg-gradient-to-br from-orange-300 to-red-400 rounded flex items-center justify-center mb-1">
                          <Target className="h-4 w-4 text-white" />
                        </div>
                        <div className="text-xs text-center text-gray-600 truncate">{lastRejectedHackathon.title}</div>
