                  ...
                  {showUndo.people && lastRejectedPerson && (
                    ...
                    >
                      <div className="bg-white rounded-lg shadow-lg border-2 border-red-300 p-2 w-16 h-20 cursor-pointer hover:shadow-xl hover:scale-105 transition-all duration-200"
                        ...
                        <div className="h-10 bg-gradient-to-br from-red-400 to-red-500 rounded flex items-center justify-center mb-1">
                          <User className="h-4 w-4 text-white" />
                        </div>
                        <div className="text-xs text-center text-gray-600 truncate mb-1">{lastRejectedPerson.name}</div>
            ...
            <div className="max-w-md mx-auto">
              ...
              {hackathons[currentHackathonIndex] ? (
                <div className="relative overflow-visible h-[600px]">
                  ...
                  <div className="absolute top-8 left-8 right-8 bottom-8 bg-white rounded-2xl shadow-2xl z-1 transform rotate-1 scale-92 opacity-75 border-4 border-orange-300">
                    ...
                    <div className="p-4">
                      <div className="h-6 bg-orange-300 rounded mb-3"></div>
                  ...
                  <div className="absolute top-4 left-4 right-4 bottom-4 bg-white rounded-2xl shadow-2xl z-2 transform rotate-0.5 scale-96 opacity-85 border-4 border-orange-400">
                    <div className="h-48 bg-gradient-to-br from-orange-500 to-red-600 rounded-t-2xl flex items-center justify-center">
                  ...
                  <div className="absolute top-0 right-[-150px] w-full h-full bg-white rounded-2xl shadow-2xl z-1 transform rotate-3 scale-85 opacity-80 border-4 border-red-400">
                    <div className="h-48 bg-gradient-to-br from-red-500 to-orange-600 rounded-t-2xl flex items-center justify-center">
                      <div className="text-white font-black text-2xl bg-black bg-opacity-60 px-6 py-3 rounded-full shadow-lg">
                        NEXT →
                      </div>
                    </div>
                    <div className="p-4">
                      <div className="h-8 bg-red-300 rounded mb-4"></div>
                      <div className="h-6 bg-red-200 rounded mb-3"></div>
                  ...
                  {showUndo.hackathons && lastRejectedHackathon && (
                    ...
                    >
                      <div className="bg-white rounded-xl shadow-2xl border-4 border-red-400 p-4 w-32 h-36 cursor-pointer hover:shadow-3xl hover:scale-105 transition-all duration-300 bg-gradient-to-b from-white to-red-50"
                        ...
                        <div className="h-16 bg-gradient-to-br from-orange-400 to-red-500 rounded-lg flex items-center justify-center mb-2 shadow-lg">
                          <Target className="h-6 w-6 text-white" />
                        </div>
                        <div className="text-sm text-center font-semibold text-gray-700 truncate mb-1">{lastRejectedHackathon.title}</div>
                        <div className="flex items-center justify-center">
            ...
            <div className="max-w-md mx-auto">
              ...
              {projects[currentProjectIndex] ? (
                <div className="relative overflow-visible h-[600px]">
                  ...
                  {/* Third Card - VERY OBVIOUS */}
                  <div className="absolute top-8 left-8 right-8 bottom-8 bg-white rounded-2xl shadow-2xl z-1 transform rotate-1 scale-92 opacity-75 border-4 border-green-300">
                    <div className="h-48 bg-gradient-to-br from-green-400 to-teal-500 rounded-t-2xl flex items-center justify-center">
                      <div className="text-white font-bold text-lg bg-black bg-opacity-50 px-4 py-2 rounded-full">CARD 3</div>
                    </div>
                    <div className="p-4">
                  ...
                  {/* Second Card - CLEARLY BEHIND MAIN CARD */}
                  <div className="absolute top-4 left-4 right-4 bottom-4 bg-white rounded-2xl shadow-2xl z-2 transform rotate-0.5 scale-96 opacity-85 border-4 border-green-400">
                    <div className="h-48 bg-gradient-to-br from-green-500 to-teal-600 rounded-t-2xl flex items-center justify-center">
                      <div className="text-white font-bold text-xl bg-black bg-opacity-50 px-4 py-2 rounded-full">
                    ...
                    <div className="p-4">
                      <div className="h-6 bg-green-300 rounded mb-3"></div>
                      <div className="h-5 bg-green-200 rounded mb-2"></div>
                      <div className="h-5 bg-green-200 rounded w-3/4"></div>
                    </div>
                  </div>
                  
                  {/* MASSIVE NEXT Card Peek from Right Side - SUPER VISIBLE */}
                  <div className="absolute top-0 right-[-150px] w-full h-full bg-white rounded-2xl shadow-2xl z-1 transform rotate-3 scale-85 opacity-80 border-4 border-teal-400">
                    <div className="h-48 bg-gradient-to-br from-teal-500 to-green-600 rounded-t-2xl flex items-center justify-center">
                      <div className="text-white font-black text-2xl bg-black bg-opacity-60 px-6 py-3 rounded-full shadow-lg">
                        NEXT →
                      </div>
                    </div>
                    <div className="p-4">
                      <div className="h-8 bg-teal-300 rounded mb-4"></div>
                      <div className="h-6 bg-teal-200 rounded mb-3"></div>
                  ...
                  {showUndo.projects && lastRejectedProject && (
                    ...
                    >
                      <div className="bg-white rounded-xl shadow-2xl border-4 border-red-400 p-4 w-32 h-36 cursor-pointer hover:shadow-3xl hover:scale-105 transition-all duration-300 bg-gradient-to-b from-white to-red-50"
                        ...
                        <div className="h-16 bg-gradient-to-br from-green-400 to-teal-500 rounded-lg flex items-center justify-center mb-2 shadow-lg">
                          <Code className="h-6 w-6 text-white" />
                        </div>
                        <div className="text-sm text-center font-semibold text-gray-700 truncate mb-1">{lastRejectedProject.title}</div>
                        <div className="flex items-center justify-center">
                          <div className="bg-red-100 rounded-full p-1">
                            <Undo className="h-4 w-4 text-red-600" />
                          </div>
